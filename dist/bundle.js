...
(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['mithril', './models/Entry', './components/EntryList', './components/EntryForm'], factory);
  } else if (typeof exports !== "undefined") {
    factory(require('mithril'), require('./models/Entry'), require('./components/EntryList'), require('./components/EntryForm'));
  } else {
    var mod = {
      exports: {}
    };
    factory(global.mithril, global.Entry, global.EntryList, global.EntryForm);
    global.app = mod.exports;
  }
})(this, function (_mithril, _Entry, _EntryList, _EntryForm) {
  ...
  _mithril2.default.route(document.getElementById('app'), '/', {
    ...
    '/entries/new': new _EntryForm2.default(),
    '/example': {
      ...
      view: function view(ctrl) {
        return (0, _mithril2.default)('.example-page', [(0, _mithril2.default)('a[href=/]', {
          config: _mithril2.default.route
        }, "< Back"), (0, _mithril2.default)('select', ctrl.data.map(function (n) {
...
(function (global, factory) {
  ...
  var buildEntryView = function buildEntryView(entry) {
    ...
    return (0, _mithril2.default)('.entry', [(0, _mithril2.default)('label', 'Entered at: ' + date.toString()), (0, _mithril2.default)('ul', entry.volunteers.map(buildVolunteerView))]);
  };

  var buildVolunteerView = function buildVolunteerView(volunteer) {
    return (0, _mithril2.default)('li.volunteer', [(0, _mithril2.default)('label', volunteer.name), (0, _mithril2.default)('label', '(' + volunteer.email + ')')]);
  };
  ...
  var EntryList = (function () {
    ...
    _createClass(EntryList, [{
      key: 'view',
      value: function view() {
        return (0, _mithril2.default)('.entry-list', [(0, _mithril2.default)('h1', 'All entries'), (0, _mithril2.default)('a[href=/entries/new]', {
          config: _mithril2.default.route
        }, 'Add New Entry'), (0, _Entry.all)().map(buildEntryView)]);
      }
    }]);
...
(function (global, factory) {
  ...
  var create = exports.create = function create(attrs) {
    attrs.id = idCounter += 1;
    attrs.enteredAt = Date.now();
    store.push(attrs);
  };

  var VM = exports.VM = function VM() {
    return {
      enteredAt: null,
  ...
  var volunteerVM = exports.volunteerVM = function volunteerVM() {
    return {
      name: '[Your name]',
      email: '[Your email]'
    };
